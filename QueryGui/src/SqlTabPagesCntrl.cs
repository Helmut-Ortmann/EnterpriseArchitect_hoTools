...
";
        ...
        public TabPage AddTab(bool withDefaultTabContent = true)
        {
            ...
            SqlFile sqlFile = new SqlFile(this, tabPage, $"{DefaultTabName}{_tabControl.Controls.Count}.sql", isChanged:false);
            tabPage.Tag = sqlFile;
            ...
            loadTabMenuItem.Text = @"Load File (CTRL+L)";
        ...
        ToolStripMenuItem GetTemplateMenuItems()
        {
            ...
            {
                Text = @"ACCESS2007",
                ToolTipText = SqlTemplates.getTooltip(SqlTemplates.SQL_TEMPLATE_ID.DB_ACCESS2007),
                Tag = SqlTemplates.getTemplate(SqlTemplates.SQL_TEMPLATE_ID.DB_ACCESS2007)
            };
            insertDbaccess2007TemplateMenuItem.Click += insertTemplate_Click;

            // DB ASA
            ToolStripMenuItem insertDbAsaTemplateMenuItem = new ToolStripMenuItem {Text = @"ASA"};
