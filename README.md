...
- [hoTools](https://github.com/Helmut-Ortmann/EnterpriseArchitect_hoTools/wiki/hoTools) Assortment of tools
  ...
  - Version Control + SVN
  - [Quick Search](https://github.com/Helmut-Ortmann/EnterpriseArchitect_hoTools/wiki/QuickSearch)
...
- SQL for Diagram
- SQL for selected Elements in Diagram and Tree 
