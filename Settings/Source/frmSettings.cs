...
namespace ho_Tools.Settings
{
    public partial class frmSettings : Form
    {
        ...
        private AddinControl _addinControl = null;
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            _settings.shortcutsServices[0].ButtonText = txtButton1TextService.Text.ToString();
            _settings.shortcutsServices[1].GUID = cmbService2.SelectedValue.ToString();
            _settings.shortcutsServices[1].ButtonText = txtButton2TextService.Text.ToString();
            _settings.shortcutsServices[2].GUID = cmbService3.SelectedValue.ToString();
            _settings.shortcutsServices[2].ButtonText = txtButton3TextService.Text.ToString();
            _settings.shortcutsServices[3].GUID = cmbService4.SelectedValue.ToString();
            _settings.shortcutsServices[3].ButtonText = txtButton4TextService.Text.ToString();
            _settings.shortcutsServices[4].GUID = cmbService5.SelectedValue.ToString();
            _settings.shortcutsServices[4].ButtonText = txtButton5TextService.Text.ToString();
            #endregion
            ...
            _addinControl.parameterizeShortCutsQueries(); // sets the shortcuts
            _addinControl.parameterizeShortCutsServices(); // sets the shortcuts
        ...
        private int serviceGetIndex(List<EaServices.ServiceCall> l_services, string GUID)
        {
            for (int i = 0; i < l_services.Count; i = i + 1)
            {
                if (_settings.shortcutsServices[0].GUID == l_services[i].GUID) return i;
            }
            return -1;
        }
