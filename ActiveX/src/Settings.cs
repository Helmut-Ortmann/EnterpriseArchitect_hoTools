...
namespace hoTools.Settings
{
    ...
    public class AddinSettings
    {
        ...
        public List<ServiceCall> AllServices;
        ...
        // Connectors
        public LogicalConnectors LogicalConnectors;
        public ActivityConnectors ActivityConnectors;
...
#pragma warning restore 1570
        ...
        {
            ActivityConnectors = new ActivityConnectors();
            LogicalConnectors = new LogicalConnectors();
            GlobalShortcutsSearch = new  List<GlobalKeysConfig.GlobalKeysSearchConfig>();
            GlobalShortcutsService = new List<GlobalKeysConfig.GlobalKeysServiceConfig>();
            AllServices = new List<ServiceCall>();
            GetDefaultSettings();
        ...
        {
            foreach (EaAddinButtons buttom in l)
            {
                if (buttom is EaAddinShortcutSearch)
                {

                    var el = (EaAddinShortcutSearch)buttom;
        ...
        List<ServicesCallConfig> GetShortcutsServices()
        {
